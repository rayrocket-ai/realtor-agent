...
- **New-listing matcher** — every morning at 9:00 the matcher checks the live PropTx MLS feed against each buyer profile (budget, areas, beds, property type) and drafts a short personal message pitching up to 3 fresh matches per buyer — never the same listing twice, never homes they've already seen, always through your approval mode. Matches show on each buyer's card and in the morning briefing. Requires the PropTx connection; without it the job just skips.
